...
const TutorDropdown = ({ onChange }) => {
  ...
  return (
    <div >
      <label htmlFor="mainDropdown" style={{marginLeft: "-25%"}}>Select a Course:</label>
      <select
        id="mainDropdown"
      ...
      {selectedMainOption && (
        <div className="sub-dropdown-container">
          <label htmlFor="subDropdown" style={{marginTop: "14%", marginLeft: "-25%", marginRight: "-150%" }}>Select a Sub-Course:</label>
          <select
            id="subDropdown"
