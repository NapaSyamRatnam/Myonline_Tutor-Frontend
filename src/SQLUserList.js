...
//   useEffect(() => {
//     axios.get(`http://localhost:8080/api/users/byCourse/Technical - SQL`)
//       .then(response => {
...
function SQLUserList() {
  ...
  const fetchData = () => {
    axios.get(`http://192.168.138.130:8080/api/users/byCourse/Technical -SQL `)
      .then(response => {
    ...
    axios.get(`http://192.168.138.130:8080/api-v1/by-course/SQL`)
      .then(response => {
