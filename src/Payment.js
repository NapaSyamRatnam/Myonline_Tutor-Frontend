...
// import './Payment.css'; // Updated CSS file name
...
//     e.preventDefault();
//     // Basic validation
//     if (!cardNumber || !expiry || !cvv || !name || !amount) {
...
//       return;
//     }
//     // Here, you would integrate with your payment gateway SDK/API to process payments
//     // Example: Call a payment processing function or API endpoint
...
//         <button type="submit" className="payment-form-button">Pay Now</button>
//       </form>
//       {showPopup && (
//         <div className="payment-popup">
//           <p className="payment-popup-message">Card Details successful!</p>
//           <Link to="/PaymentSubmit">
//             <button className="payment-popup-button" onClick={() => setShowPopup(false)}>Close</button>
//           </Link>
//         </div>
//       )}
//     </div>
