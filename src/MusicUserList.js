...
// function MusicUserList(){
//   const { courseType } = useParams();
//   const [users, setUsers] = useState([]);

//   useEffect(() => {
//     axios.get(`http://localhost:8080/api/users/by-course/Professional - Music`)
//       .then(response => {
...
function MusicUserList() {
  ...
  const fetchData = () => {
    axios.get(`http://192.168.138.130:8080/api/users/by-course/Professional - Music`)
      .then(response => {
    ...
    axios.get(`http://192.168.138.130:8080/api-v1/by-course/Music`)
      .then(response => {
