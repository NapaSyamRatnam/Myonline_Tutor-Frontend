...
// function CollegeUserList() {
//   const { courseType } = useParams();
//   const [users, setUsers] = useState([]);

//   useEffect(() => {
//     axios.get(`http://localhost:8080/api/users/byCourse/Academic- College`)
//       .then(response => {
...
// export default CollegeUserList;
...
function CollegeUserList() {
  ...
  const fetchData = () => {
    axios.get(`http://192.168.138.130:8080/api/users/by-course/Academic-College`)
      .then(response => {
              ...
              <div className="modal-dialog col-8" role="document">
                <div className="modal-content">
                  ...
                  <div className="modal-footer">
                    <button type="button" className="btn btn-secondary" onClick={handleModalClose} style={{width:'200px'}}>
                      Close
                    </button>
