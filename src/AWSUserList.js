...
//   useEffect(() => {
//     axios.get(`http://localhost:8080/api/users/byCourse/Technical - AWS`)
//       .then(response => {
...
function AWSUserList() {
  ...
  const fetchData = () => {
    axios.get(`http://192.168.138.130:8080/api/users/by-course/Technical - AWS`)
      .then(response => {
