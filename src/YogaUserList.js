...
// function YogaUserList() {
//   const { courseType } = useParams();
//   const [users, setUsers] = useState([]);

//   useEffect(() => {
//     axios.get(`http://localhost:8080/api/users/byCourse/Professional - Yoga`)
//       .then(response => {
...
function YogaUserList() {
  ...
  const fetchData = () => {
    axios.get(`http://192.168.138.130:8080/api/users/byCourse/Professional -Yoga`)
      .then(response => {
    ...
    axios.get(`http://192.168.138.130:8080/api-v1/by-course/Yoga`)
      .then(response => {
