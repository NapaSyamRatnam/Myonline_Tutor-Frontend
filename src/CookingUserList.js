...
// function CookingUserList() {
//   const { courseType } = useParams();
//   const [users, setUsers] = useState([]);

//   useEffect(() => {
//     axios.get(`http://localhost:8080/api/users/byCourse/Professional - Cooking`)
//       .then(response => {
...
// export default CookingUserList;
...
function CookingUserList() {
  ...
  const fetchData = () => {
    axios.get(`http://192.168.138.130:8080/api/users/byCourse/Professional - Cooking`)
      .then(response => {
    ...
    axios.get(`http://192.168.138.130:8080/api-v1/by-course/Cooking`)
      .then(response => {
